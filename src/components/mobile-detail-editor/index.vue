  ...
  <div class="mobile-detail-editor">
          ...
          <div v-else-if="item.type === 'image'">
            ...
            >
              ...
              <img
                :src="image.url"
                width="100%"
                :class="image.style.hasMargin ? 'mb-2' : ''"
              />
            </div>
          </div>
    ...
    >
      ...
      <div class="main">
        ...
        <!-- 中间内容 -->
        <div
          :class="['content', false && 'pointer-events-none']"
          @drop="drop"
          @dragover="allowDrop"
        ...
        >
          ...
          <template v-else-if="activeModule.type === 'image'">
            ...
            <a-checkbox
              ...
              v-model:checked="activeModule.hasMargin"
              @change="toggleHasMargin"
...
<script setup>
  ...
  watch(
    () => props.mobileDetail,
    val => {
      // moduleList.value = cloneDeep(val)
  ...
  function selectModule(e, item, i) {
    activeModuleIndex.value = i
    // 获取当前点击模块距离顶部的距离, 给右侧详情窗口设置一样的 top 值
    // offsetTop.value = e.currentTarget.offsetTop - 36
  ...
  // 切换是否保留间隙
  function toggleHasMargin(e) {
    activeModule.value.images.forEach(imageItem => {
      imageItem.style.hasMargin = !e.target.checked
    })
  }
  function add() {
