...
<template>
  <a-modal
    :open="open"
    :title="`选择店铺-认领到${claimType === 'acquisition' ? '采集箱' : '待发布'}`"
    width="50%"
    @cancel="handleCancel"
  >
    <div class="flex">
      ...
      <a-card class="flex-[3] mr-4 overflow-auto">
        ...
        >
          ...
          <div>
            ...
            >
              <a-checkbox
                v-for="shop in item.platformShopList"
                :key="shop.shopId"
                :value="shop.shopId"
      ...
      <a-card class="flex-[1]">
        ...
        <div class="h-105 overflow-auto">
          <div
            ...
            :key="item.value"
            class="flex justify-between p-1 hover:bg-gray-50 group"
          >
            <div
              class="w-40 truncate"
