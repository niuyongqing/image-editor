<script setup>
  ...
  function getUserInfo() {
    const userInfoJSON = Cookie.get('userInfo')
    if (userInfoJSON) {
      const userInfo = JSON.parse(userInfoJSON)
      if (userInfo.remember) {
        loginModel.username = userInfo.username
  ...
  async function submit() {
    ...
    try {
      ...
      if (loginModel.remember) {
        ...
        Cookie.set('userInfo', JSON.stringify(userInfo), { expires: 30 })
      } else {
      ...
      <div class="ant-pro-form-login-main rounded">
        ...
        <div class="flex-between h-15 px-4 mb-[2px]">
          <div class="flex-end">
            ...
            <span class="ant-pro-form-login-title"> Xin Zhan </span>
        ...
        <div class="box-border flex min-h-[520px]">
          ...
          <div class="ant-pro-form-login-main-right px-5 w-[335px] flex-center flex-col relative z-11">
            ...
            >
              <a-tabs
                v-model:active-key="loginModel.type"
                centered
              >
                <a-tab-pane
                  key="account"
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <template v-else> {{ resetCounter - counter }} {{ t('pages.getCaptchaSecondText') }} </template>
                    </a-button>
                  </div>
                </a-form-item>
              </template>
