<template>
<div id="amazonShopManage">
  <div style="padding: 0">
    <el-card>
      <el-form :inline="true" :model="formInline" class="demo-form-inline" ref="ruleForm">
        <el-form-item label="店铺名称：" prop="userId">
          <el-input v-model="formInline.shopName" placeholder="请输入内容"></el-input>
        </el-form-item>

        <el-form-item label="简称：" prop="depId">
          <el-input v-model="formInline.simpleName" placeholder="请输入内容"></el-input>
        </el-form-item>
    ...
    <el-card>
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button type="primary" icon="el-icon-plus" @click="add()"
                      v-has-permi="['system:platform:amazon:shop:add']" v-waves>新增
          </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button type="success" icon="el-icon-edit" @click="Edit()" :disabled="selectRow.length !== 1" v-waves
                      v-has-permi="['system:platform:amazon:shop:edit']">修改
          </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-popconfirm
            ...
            iconColor="success"
            title="确定删除选中账号吗？"
            v-has-permi="['system:platform:amazon:shop:del']"
            @confirm="del()"
          >
      ...
      <div style="padding: 3px 0">
        ...
        <el-table 
          ...
          v-loading="loading" class="tabClass" 
  ...
  <!-- 新增 -->
  <shop-manage-add :dialogVisible.sync="addShow"></shop-manage-add>

  <!-- 修改 -->
  <shop-manage-edit :dialogVisible.sync="editShow" :selectRow="selectRow"></shop-manage-edit>
</div>
</template>

<script>
import {settingList, settingTableEdit} from "@/api/systemSetting/setting";
import {shopList, delShop} from "@/views/platform/amazon/js/api/shopManage.js";

import tableHeard from "@/views/platform/amazon/js/tableHead/shopManage.js";
import Sortable from "sortablejs";

import shopManageAdd from "@/views/platform/amazon/shopManage/common/shopManageAdd.vue";
import shopManageEdit from "@/views/platform/amazon/shopManage/common/shopManageEdit.vue";
export default {
  name: 'amazonShopManage',
  components: {
    shopManageAdd,
    shopManageEdit
  },
  data() {
    return {
      ...
      selectRow:[],//选择的行 row
      addShow: false,//新增组件状态
      editShow: false,//修改组件状态
    }
  },
  mounted() {
    this.getList()
  ...
  methods: { 
    ...
    getList() {
      let data = {
        ...
        simpleName: this.formInline.simpleName
      }
      this.loading = true
