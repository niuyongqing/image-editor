...
import { exportTemplate } from "~/pages/financialStatements/aliexpress/dataConfig/semiManagedReturnPackage/js/api.js";
...
const executeUpload = async ( file ) => {
  try {
    ...
    return await axios.post ( '/prod-api/report-aliexpress/report/aliexpress/return/package/import', formData, {
      headers: {
