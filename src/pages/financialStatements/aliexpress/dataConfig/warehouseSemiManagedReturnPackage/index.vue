...
defineOptions({ name: 'warehouseSemiManagedReturnPackage' });
import { ref, reactive, defineAsyncComponent, onMounted, computed } from 'vue';
import { DeleteOutlined, UploadOutlined, VerticalAlignBottomOutlined } from "@ant-design/icons-vue";
import dayjs from "dayjs";
import { message } from "ant-design-vue";
import { eprList, userList, batchDelete, exportEprList,dictList } from "~/pages/financialStatements/aliexpress/dataConfig/warehouseSemiManagedReturnPackage/js/api.js";
import tableHeader from '@/pages/financialStatements/aliexpress/dataConfig/warehouseSemiManagedReturnPackage/js/tableHeader.js';
...
const importModel = defineAsyncComponent(() => import('@/pages/financialStatements/aliexpress/dataConfig/warehouseSemiManagedReturnPackage/common/importModel.vue'));

const resetSetMenu = 'warehouseSemiManagedReturnPackage';
