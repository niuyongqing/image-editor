...
import { exportTemplate } from "~/pages/financialStatements/aliexpress/dataConfig/warehouseSemiManagedReturnPackage/js/api.js";
...
const executeUpload = async ( file ) => {
  try {
    ...
    return await axios.post ( '/prod-api/report-aliexpress/report/aliexpress/return/package/freight/import', formData, {
      headers: {
