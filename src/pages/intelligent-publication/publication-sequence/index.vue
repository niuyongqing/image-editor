...
<div id="publication_sequence" class="publication_sequence">
  <a-card>
    <a-form :model="formData">
      <a-form-item label="刊登店铺" name="刊登店铺prop">
        <selectComm 
          style="margin-left: 10px" 
          :options="options.店铺列表data" 
          :fieldObj="{ fieldKey: 'id', fieldLabel: 'label',}" 
      ...
      <a-form-item class="tradeName-item" label="模糊查找" name="tradeName">
        <a-form-item-rest>
          <div flex gap-10px style="width: 300px;">
            ...
            <a-input v-model:value="formData.skuCode" placeholder="产品ID"></a-input>
          </div>
        </a-form-item-rest>
      </a-form-item>
      <a-form-item class="tradeName-item" label="刊登模式" name="tradeName">
        <selectComm 
          style="margin-left: 10px" 
          :options="options.店铺列表data" 
          :fieldObj="{ fieldKey: 'id', fieldLabel: 'label',}" 
      ...
      <div class="formItem-row-i right" style="text-align: right;">
        <a-space>
