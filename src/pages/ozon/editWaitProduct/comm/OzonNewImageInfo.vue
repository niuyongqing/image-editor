    ...
    <a-card class="text-left">
      ...
      <a-form ref="ruleForm" class="richForm" :model="form" :label-col="{ span: 2 }">
        ...
        <a-form-item label="JSON富文本：">
          ...
          <a-form-item-rest>
            <jsonForm @backResult="backResult" :jsonContent="form.jsons" :shop="shopCode" @clear="form.jsons = ''">
            </jsonForm>
          </a-form-item-rest>
        </a-form-item>
            ...
            <div class="ml-7.5 flex flex-col">
              ...
              <div class="flex">
                ...
                <div v-if="form.video.length < 5">
                  <a-upload ref="uploadVideo" list-type="picture-card" class="avatar-uploader" :action="uploadVideoUrl"
                    :data="{
                      shortCode: shopCode,
