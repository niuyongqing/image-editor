...
export const DEFAULT_TABLE_COLUMN = [
  ...
  { title: '广告类型', key: 'placement', align: 'center', fixed: 'left' },
  { title: '广告产品', key: 'productCount', align: 'right' },
  { title: '付费类型', key: 'advObjectType', align: 'center' },
  { title: '广告策略', key: 'productAutopilotStrategy', align: 'center' },
  { title: '每日预算', key: 'dailyBudget', align: 'right' },
  { title: '每周预算', key: 'weeklyBudget', align: 'right' },
  ...
  { title: '广告费用占比', key: 'proportionAdvertisingExpenses', align: 'right' },
  { title: '展示次数', key: 'displayCount', align: 'right' },
  { title: '点击量', key: 'hits', align: 'right' },
  { title: '添加购物车次数', key: 'shoppingCartcQuantity', align: 'right' },
  { title: '点击率', key: 'clickRate', align: 'right' },
  { title: '平均点击价格', key: 'averageClickPrice', align: 'right' },
  { title: '平均利率', key: 'averageInterestRate', align: 'right' },
  { title: 'CPM', key: 'cpm', align: 'right' },
  { title: '活动状态', key: 'activityState', align: 'center', fixed: 'right' },
  { title: '启用状态', key: 'state', align: 'center', fixed: 'right' },
