<template>
    <div flex>
        ...
        <div>
            ...
            <div v-if="type === 'draft'" w-full>
                <div id="draft" w-full ml-15px>
                        ...
                        <a-form ref="ruleForm2" :model="formData">
                            ...
                            <a-form-item label="搜索类型:">
                                <div class="fBox flex align-start gap-10px">
                                    <a-button @click="selectTypes(item.prop)"
                            ...
                            <a-form-item label="搜索内容：">
                                <div class="flex">
                                    <div class="flex align-start">
                                        <a-input v-if="actives === 1" style="width: 400px;"
                                            v-model:value="formData.name" placeholder="请输入标题查询" clearable
                                            @clear="onSubmit"></a-input>
                    ...
                    <a-card class="my-2.5">
                        ...
                        <a-table :row-selection="rowSelection" rowKey="gatherProductId" :data-source="tableData"
                            bordered :columns="columns" :pagination="false" :loading="loading">
                            <template #bodyCell="{ column, record }">
                                <template v-if="column.dataIndex === 'image'">
                                    <div class="">
                                        <a-image :src="primaryImage(record.primaryImage)" />
                                        <a-button type="link" class="platform-name"
                                ...
                                <template v-if="column.dataIndex === 'sku'">
                                    <div class="record-sku-container pb-30px">
                                        <div class="record-sku" v-for="(item, index) in displayedSkus(record)"
                                            :key="index">
                                            <div text-left>
            ...
            <div v-else-if="type === 'online'" w-full ml-15px>
                <OzonProduct></OzonProduct>
            </div>
            <div v-else-if="type === 'wait'" w-full ml-15px>
