<template>
  <div id="OzonBaseInfoCont">
      ...
      >
        ...
        >
          ...
          <a-button
            ...
            :disabled="categoryTreeList.length == 0"
            @click="selectVisible = true"
            >选择分类</a-button
          >
          <p
            v-if="hisAttrObj.length != 0"
            style="color: #933"
          >
            <span>{{ hisAttrObj[0].categoryName }}</span
            >/ <span>{{ hisAttrObj[0].secondCategoryName }}</span
            >/
        ...
        <a-form-item label="产品属性：">
          ...
          >
            ...
            >
              <div
                v-for="(item, index) in sortAttrs(loopAttributes)"
                :key="index"
              ...
              >
                ...
                >
                  ...
                  <a-input
                    ...
                    v-model:value="form.attributes[item.name]"
                    :style="'width: 80%'"
                    allow-clear
    ...
    <categoryDialog
      @getAttributesID="getAttributesID"
      :categoryTreeList="categoryTreeList"
      :selectVisible="selectVisible"
      @handleEditClose="selectVisible = false"
    ></categoryDialog>
  </div>
</template>
