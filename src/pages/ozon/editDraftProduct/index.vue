        ...
        <div>
          <a-space>
            ...
            <a-button
              type="primary"
              @click="onSubmit(1)"
              style="height: 32px; background-color: #ff8345; color: #fff"
              >保存并移入待发布</a-button
            >
            <a-button
              type="primary"
            ...
            >
            <a-button
              style="height: 32px; background-color: #096; color: #fff"
              @click="onSubmit(3)"
            >
              发布
            </a-button>
        ...
        >
          <a-space>
            ...
            <a-button
              ...
              >保存</a-button
            >
            <a-button style="height: 32px; background-color: #096; color: #fff"> 发布 </a-button>
            <!-- <a-dropdown>
                            <a-button style="height: 32px; background-color: #096; color: #fff;">
                                发布
                                <DownOutlined />
