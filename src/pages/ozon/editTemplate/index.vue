  ...
  <div id="editDraftProduct" class="pr-14">
    <div class="w-19/20">
      <div flex w-full justify-between items-center>
        <div>
          <a-breadcrumb separator=">">
            ...
            <a-breadcrumb-item>编辑模板 </a-breadcrumb-item>
          </a-breadcrumb>
        </div>
        <div>
      ...
      <ozon-base-info ref="ozonBaseInfoRef" id="ozonBaseInfo" :productDetail="productDetail"
        ...
        @getAttributes="getAttributes" @emitAddDescription="addDescription" @sendShortCode="sendShortCode"
        :showDescription="showDescription"></ozon-base-info>
      <br />

      <!-- 描述信息 -->
      <OzonNewImageInfo ref="ozonImageInfoRef" :shopCode="formData.shortCode" v-if="showDescription && type === '1'"
        :productDetail="productDetail" v-model:showDescription="showDescription" :type="type">
      </OzonNewImageInfo>
      <!-- 变种信息. -->
...
const onSubmit = async () => {
  ...
  if (type.value === '1') {
    ...
    params = {
      id: isCopy.value ? null : productDetail.value.id,
