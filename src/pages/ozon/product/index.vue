          ...
          >
            ...
            <a-form-item>
              <div class="text-right mr-15">
                ...
                <a-button type="link" class="mx-2.5" @click="resetForm"
                  >重置</a-button
                >
            ...
            <a-dropdown>
              <template #overlay>
                <a-menu @click="handleAsyncClick">
                  <a-menu-item key="All" :loading="syncLoading"
                    >同步全部产品</a-menu-item
                  >
                  <a-menu-item
                    key="single"
            ...
            <template #bodyCell="{ column, record }">
              ...
              <div v-else-if="column.dataIndex === 'price'">
                ...
                <div v-else class="inline-block">
                  <a-input
                    ...
                    placeholder="请输原价格"
                  ></a-input>
                  <a-button class="mr-2.5" @click="priceVisible = false"
                    >取消</a-button
                  >
                  <a-button type="primary" @click="checkOldPrice(record)"
                    >确定</a-button
                  >
                </div>
                <AsyncIcon
              ...
              <div v-else-if="column.dataIndex === 'oldPrice'">
                ...
                <div v-else class="inline-block">
                  <a-input
                    ...
                    placeholder="请输原价格"
                  ></a-input>
                  <a-button class="mr-2.5" @click="singleVisible = false"
                    >取消</a-button
                  >
                  <a-button type="primary" @click="checkOldPrice(record)"
                    >确定</a-button
              ...
              <div v-else-if="column.dataIndex === 'minPrice'">
                <span
                  ...
                  "
                  >CNY {{ record.minPrice }}</span
                ><span v-if="!record.minPrice">---</span>
                <div
                ...
                >
                  <a-input
                    ...
                    placeholder="请输原价格"
                  ></a-input>
                  <a-button class="mr-2.5" @click="minPriceVisible = false"
                    >取消</a-button
                  >
                  <a-button type="primary" @click="checkOldPrice(record)"
                    >确定</a-button
                    ...
                    <a-dropdown>
                      ...
                      <template #overlay>
                        <a-menu>
                          ...
                          >
                            <a-menu-item type="text" style="color: red"
                              >删除</a-menu-item
                            >
                          </a-popconfirm>
                          <!-- v-if="
