<template>
    <div>
        <BaseModal title="批量修改仓库" @register="register" @close="cancel" @submit="submit" width="600px"
...
const uploadFileUrl = import.meta.env.VITE_APP_BASE_API + '/platform-lazada/platform/lazada/empower/import-store';
const fileList = ref([]);
