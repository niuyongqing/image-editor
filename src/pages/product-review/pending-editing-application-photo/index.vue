  ...
  <div class="pending-editing-container ml-16">
    ...
    <div class="form-wrapper">
      <a-form :model="formData" :label-col="labelCol" class="submit-form" :rules="formRules" ref="formRef"
        ...
        <!-- 产品基本信息行 -->
        <a-form-item label="产品名称:" name="productName" class="w24">
          <a-input v-model:value="formData.productName" allow-clear placeholder="请输入产品名称" />
        </a-form-item>
        <a-form-item label="产品分类:" name="productCategory" class="w24">
          <a-cascader placeholder="请选择产品分类" allowClear v-model:value="formData.productCategory"
            :options="commodityTypeList" :allow-clear="true"
            :field-names="{ label: 'label', value: 'value', children: 'children' }" />
        </a-form-item>
        <a-form-item label="产品SKU:" name="productSku" class="w24">
          <a-input v-model:value="formData.productSku" allow-clear placeholder="请输入产品SKU" />
        </a-form-item>
        ...
        <div class="form-row mt-16">
          <div class="form-item">
            <a-form-item label="参考图:" name="referenceImage1">
...
const formRules = {
  ...
  referenceImage: [
    { required: true, message: '请上传参考图', trigger: 'change' }
  ]
};
 ...
 * @param index 图片索引
 */
const removeImage = (index: number | 'all') => {
  if (index === 'all') {
