...
<template>
  <div >
      <a-form layout="inline" :model="formState" @finish="handleFinish" @finishFailed="handleFinishFailed" style="margin-top:10px">
        <a-form-item>
          <a-input v-model:value="formState.userName" placeholder="姓名"></a-input>
        </a-form-item>
        <a-form-item>
          <a-input v-model:value="formState.phonenumber" placeholder="手机号码"></a-input>
        </a-form-item>
        <a-form-item>
    ...
    <add-or-edit :title="title" :open="open" :data="editData" @close="close" :dept="dept"></add-or-edit>
  </div>
</template>
