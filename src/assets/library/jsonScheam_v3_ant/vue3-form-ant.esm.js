...
import { h, inject, computed, ref, watch, toRaw, getCurrentInstance, toRef, provide, defineComponent, onMounted } from 'vue';
import { resolveComponent, getPathVal, setPathVal, isRootNodePath, path2prop, computedCurPath, deletePathVal, nodePath2ClassName, modelValueComponent } from '@lljj/vjsf-utils/vue3Utils';
...
import { isObject, genId, lowerCase, getSchemaType, isEmptyObject, filterObject, deepEquals } from '@lljj/vjsf-utils/utils';
import { fallbackLabel, getUiOptions, orderProperties, isSelect, optionsList, getWidgetConfig, replaceArrayIndex, allowAdditionalItems, getUserUiOptions, isMultiSelect, isFixedItems, getUserErrOptions, getUiField, isHiddenWidget } from '@lljj/vjsf-utils/formUtils';
...
import { IconQuestion, IconCaretUp, IconCaretDown, IconClose, IconPlus } from '@lljj/vjsf-utils/icons';
import { validateFormDataAndTransformMsg, isValid, getMatchingOption } from '@lljj/vjsf-utils/schema/validate';
import * as validate from '@lljj/vjsf-utils/schema/validate';
export { validate as schemaValidate };
import { cutOff, moveUpAt, moveDownAt, removeAt } from '@lljj/vjsf-utils/arrayUtils';
...
var Widget = {
  ...
  setup: function setup(props, _ref) {
    ...
    var widgetRef = ref(null); // 提供一种特殊的配置 允许直接访问到 widget vm
...
var ObjectField = {
  ...
  setup: function setup(props) {
    ...
    return function () {
      ...
      return h(FieldGroupWrap, _objectSpread2({
        title: title,
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      return h('div', {
        ...
        }, [h(IconClose)])]), h('div', _objectSpread2(_objectSpread2({}, !canAdd.value ? {
          paddingTop: '0px'
        } : {}), {}, {
          class: {
...
var ArrayFieldTuple = {
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      return h(FieldGroupWrap, _objectSpread2(_objectSpread2({
        title: title,
        description: description,
        showTitle: showTitle,
        showDescription: showDescription,
...
var ArrayField = {
  ...
  setup: function setup(props) {
    ...
    var formKeys = ref(getCurFormData().map(function () {
      return genId();
    })); // 当前 formData
...
var SelectLinkageField = {
  ...
  setup: function setup(props) {
    ...
    var curSelectIndex = ref(computedCurSelectIndexByFormData(getPathVal(props.rootFormData, props.curNodePath))); // 下拉选项 VNode
    ...
    return function () {
      ...
      if (curSelectSchema && !isObjectEmptyAttachProperties) {
        ...
        childrenVNodeList.unshift(h(SchemaField, _objectSpread2(_objectSpread2({
      ...
      childrenVNodeList.unshift(h(Widget, {
...
function createForm() {
  ...
  var Form = {
    ...
    setup: function setup(props, _ref) {
      ...
      var rootFormData = ref(getDefaultFormState(props.schema, props.modelValue, props.schema, props.strictMode));
...
var baseComponent$2 = {
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      return h(resolveComponent('a-select'), _objectSpread2(_objectSpread2(_objectSpread2({}, attrs.multiple ? {
        mode: 'multiple'
      } : {}), attrs), {}, {
        showSearch: type,
        // filterOption: type,
    ...
    formItem: defineComponent({
      ...
      setup: function setup(props, _ref2) {
        var attrs = _ref2.attrs,
            slots = _ref2.slots;
        var formItemRef = ref(null); // if (!attrs._title) {
        //     return null;
        // }
...
export { JsonSchemaFormAntdV4, SchemaField, vueProps$1 as fieldProps, globalOptions, index as i18n };
