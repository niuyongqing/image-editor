  ...
  <div class="ant-pro-basicLayout" :data-theme="theme">
    <a-layout class="fixed-layout">
      ...
      <a-layout>
        ...
        <a-layout-content class="ant-pro-basicLayout-content" flex flex-col style="height: 100%;overflow: auto">
          <div style="width: 100%;margin: 0 auto;padding: 0" :class="contentCls">
            <slot />
          </div>
        </a-layout-content>
...
///* 页面内容 */
//.content {
//  margin-top: 60px; /* 给内容一个顶部间距，以避免与固定布局重叠 */
//  padding: 20px;
//}
</style>
